...
comment "Add weapons";
this addWeapon "CUP_arifle_M4A1_GL_carryhandle_camo";
...
for "_i" from 1 to 9 do {this addItemToVest "CUP_30Rnd_556x45_Emag";};
this addItemToVest "CUP_17Rnd_9x19_glock17";
for "_i" from 1 to 9 do {this addItemToBackpack "CUP_1Rnd_HE_M203";};

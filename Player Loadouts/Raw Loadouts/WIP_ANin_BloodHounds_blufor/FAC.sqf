...
for "_i" from 1 to 10 do {this addItemToBackpack "CUP_1Rnd_StarFlare_White_M203";};
for "_i" from 1 to 10 do {this addItemToBackpack "ACE_40mm_Flare_white";};
...
for "_i" from 1 to 4 do {this addItemToBackpack "1Rnd_SmokeBlue_Grenade_shell";};

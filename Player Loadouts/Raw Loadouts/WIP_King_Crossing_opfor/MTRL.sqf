...
for "_i" from 1 to 10 do {this addItemToBackpack "CUP_IlumFlareGreen_GP25_M";};
for "_i" from 1 to 10 do {this addItemToBackpack "CUP_1Rnd_SmokeRed_GP25_M";};
this addHeadgear "CUP_H_RUS_ZSH_1_Goggles";

...
this addItemToBackpack "CUP_IlumFlareWhite_GP25_M";
for "_i" from 1 to 3 do {this addItemToBackpack "CUP_FlareWhite_GP25_M";};
for "_i" from 1 to 2 do {this addItemToBackpack "CUP_1Rnd_SMOKE_GP25_M";};
this addHeadgear "MNP_Helmet_SOVC_RU";
this addWeapon "CUP_arifle_AKM_GL_top_rail";

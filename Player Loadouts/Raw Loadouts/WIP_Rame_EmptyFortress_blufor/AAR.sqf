...
for "_i" from 1 to 5 do {this addItemToVest "CUP_30Rnd_TE1_Red_Tracer_545x39_AK74_plum_M";};
for "_i" from 1 to 3 do {this addItemToVest "16Rnd_9x21_Mag";};
for "_i" from 1 to 2 do {this addItemToVest "CUP_60Rnd_TE1_Red_Tracer_545x39_AK74M_M";};
for "_i" from 1 to 2 do {this addItemToBackpack "CUP_HandGrenade_RGO";};
for "_i" from 1 to 5 do {this addItemToBackpack "CUP_60Rnd_TE1_Red_Tracer_545x39_AK74M_M";};

...
this addItemToUniform "OPTRE_M2_Smoke";
this addVest "OPTRE_UNSC_M52D_Armor_Rifleman";
for "_i" from 1 to 5 do {this addItemToVest "OPTRE_32Rnd_762x51_Mag";};
...
for "_i" from 1 to 4 do {this addItemToBackpack "OPTRE_32Rnd_762x51_Mag";};
